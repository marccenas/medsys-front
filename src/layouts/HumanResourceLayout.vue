  ...
  <div class="ua-shell" :class="{ 'nav-open': navOpen }">
    ...
    <aside class="ua-sidebar">
      ...
      <nav class="ua-nav">
        ...
        <button class="ua-link" :class="{ active: isActive('residents') }" @click="go('residents')">
          <font-awesome-icon icon="user-graduate" />
          <span>Residents</span>
        </button>

        <button class="ua-link" :class="{ active: isActive('administration') }" @click="go('administration')">
          <font-awesome-icon icon="users" />
        ...
        <div class="ua-actions">
          ...
          <div class="ua-profile">
            ...
            <div class="ua-user">
              ...
              <div class="ua-user-role">Human Resource Staff</div>
            </div>
...
const pageTitle = computed(() => {
  ...
  if (p.includes("/residents")) return "residents";
  if (p.includes("/administration")) return "administration";
  return "Dashboard";
});

function go(child) {
  navOpen.value = false;
  const to = `/dashboard/human-resource/${child}`;
  if (route.path === to) return;
  router.push(to).catch(() => {});
}

function isActive(child) {
  return route.path.includes(`/dashboard/human-resource/${child}`);
}
