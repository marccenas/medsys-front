        ...
        <div class="ua-actions">
          ...
          <div class="ua-profile">
            ...
            <div class="ua-user">
              ...
              <div class="ua-user-role">Pharmacist</div>
            </div>
...
const notifications = ref([
  { id: 1, text: "New Reports.", time: "Just now", read: false },
...
function go(child) {
  navOpen.value = false;
  const to = `/dashboard/pharmacy/${child}`;
  if (route.path === to) return;
  router.push(to).catch(() => {});
}

function isActive(child) {
  return route.path.includes(`/dashboard/pharmacy/${child}`);
}
